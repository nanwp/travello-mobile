...
public class DestinationsData extends AsyncTask<Void, Void, ArrayList<DestinationModels>> {

    private String search;
    private String category;
    private ArrayList<DestinationModels> destinationModelsArrayList;
    private DestinationsDataListener listener;
    private int statusCode;
    private String message;

    public DestinationsData(String search, String category, DestinationsDataListener listener) {
        this.search = search;
            ...
            if (statusCode == 200){
                ...
                for (int i = 0; i < dataResponse.length(); i++) {
                    ...
                    destinationModelsArrayList.add(i, new DestinationModels(
                            ...
                            dat.getJSONArray("image"),
                            (float) dat.getDouble("rating"),
                            dat.getInt("jumlah_ulasan"),
